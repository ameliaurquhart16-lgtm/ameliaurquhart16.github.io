...
![](mini/images/kitten-400-350.jpeg){.absolute .editable top="170" left="30" width="400" height="400"}

![](mini/images/kitten-450-250.jpeg){.absolute .fragment .editable top="150" right="80" width="450"}

![](mini/images/kitten-300-200.jpeg){.absolute .fragment .editable bottom="110" right="130" width="300"}
...
::: {layout-ncol="2"}
![](images/moon.png){.editable}

![](images/sky.png){.editable}
:::
...
::: {layout="[1, 20]"}
![](images/presentation-menu.png){.editable width="41"}
...
::: footer
Learn more: [Navigation](https://quarto.org/docs/presentations/revealjs/presenting.html#navigation-menu) / [Jump To Slide](https://quarto.org/docs/presentations/revealjs/presenting.html#jump-to-slide)
:::
...
::: {layout="[1, 20]"}
![](images/presentation-chalkboard.png){.editable width="41"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](images/presentation-notes-canvas.png){.editable width="41"}
...
![](images/overview-mode.png){.border .editable}
...
press {{< kbd s >}} (or use the tools in presentation menu ![](../images/navigation-menu-icon.png){.editable style="padding-bottom: 1px; margin: 0" width="0.5em" height="0.5em"}) to open speaker view

![](images/speaker-view.png){.editable fig-align="center" style="border: 3px solid #dee2e6;" width="780"}
...
Press {{< kbd r >}} (or use the tools in presentation menu ![](../images/navigation-menu-icon.png){.editable style="padding-bottom: 1px; margin: 0" width="0.5em" height="0.5em"}) to open scroll view
...
::::: columns
::: {.column width="50%"}
![](images/jupyter-edit.png){.border .border-thick .editable}
:::

::: {.column width="50%"}
![](images/jupyter-preview.png){.border .border-thick .editable}
:::
:::::
...
![](images/rstudio.png){.border .editable width="900"}
